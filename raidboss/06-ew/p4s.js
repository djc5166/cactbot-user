...
Options.Triggers.push(
{
  ...
  triggers: [
    ...
    },
    {
      ...
      condition: (data, _matches) => data.act === '4',
      delaySeconds: 14,
      suppressSeconds: 9999,
      alertText: (data, _matches, output) => output.group({ num: 1, player: data.ShortName(data.purples[0]) }),
      outputStrings: act4PurpleOutputStrings,
    },
    {
      ...
      delaySeconds: 20,
      suppressSeconds: 9999,
      alertText: (data, _matches, output) => output.group({ num: 2, player: data.ShortName(data.purples[1]) }),
      outputStrings: act4PurpleOutputStrings,
    },
    {
      ...
      delaySeconds: 28,
      suppressSeconds: 9999,
      alertText: (data, _matches, output) => output.group({ num: 3, player: data.ShortName(data.purples[2]) }),
      outputStrings: act4PurpleOutputStrings,
    },
    {
      ...
      delaySeconds: 33,
      suppressSeconds: 9999,
      alertText: (data, _matches, output) => output.group({ num: 4, player: data.ShortName(data.purples[3]) }),
      outputStrings: act4PurpleOutputStrings,
    },],
  }
);
